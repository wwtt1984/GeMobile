Ext.define('GeMobile.view.typhoon.popDetail.TfPopDetailInfo', {
...
//    id: 'tfPopDetailInfo',
    ...
    config: {
        ...
        tpl: Ext.create('Ext.XTemplate',
          '<div style="min-height:2.6em;line-height:2em;font-size:1em;width:100%; text-align:center;border:#ccc solid 1px;">当前台风中心距离岱山:{toZhuJiDistance}(公里)</div>',
